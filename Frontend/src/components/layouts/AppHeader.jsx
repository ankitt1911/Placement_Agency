...
export default function AppHeader({ user, onMenu, onLogout }) {
  return (
    <header className="sticky top-0 z-30 flex h-20 items-center justify-between border-b border-portal-border bg-white/95 px-4 backdrop-blur sm:px-6">
      ...
      <CustomButton variant="secondary" className="border-red-100 bg-red-50 text-red-600 hover:border-red-200 hover:bg-red-100 hover:text-red-700" onClick={onLogout}>
